      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <?php
             $sql = "SELECT * FROM job_post INNER JOIN hirings ON job_post.id_jobpost=hirings.id_jobpost  INNER JOIN users ON users.id_user=hirings.id_user WHERE hirings.id_company='$_SESSION[id_company]'";

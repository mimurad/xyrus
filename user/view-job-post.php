...
$sql = "SELECT * FROM hirings WHERE id_user='$_SESSION[id_user]' AND id_jobpost='$_GET[id]'";
$result = $conn->query($sql);
if($result->num_rows > 0) 
{
  
  $sql1 = "SELECT * FROM job_post INNER JOIN photographers ON job_post.id_company=photographers.id_company WHERE id_jobpost='$_GET[id]'";

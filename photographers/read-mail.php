...
if($result->num_rows >  0 ){
  ...
  if($row['fromuser'] == "company") {
    $sql1 = "SELECT * FROM photographers WHERE id_company='$row[id_fromuser]'";
    ...
    $sql1 = "SELECT * FROM photographers WHERE id_company='$row[id_touser]'";
    $result1 = $conn->query($sql1);
    if($result1->num_rows >  0 ){
      $rowCompany = $result1->fetch_assoc();
    }
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="edit-profile.php"><i class="fa fa-tv"></i> My Company</a></li>
                  <li><a href="create-gallary.php"><i class="fa fa-file-o"></i> Create Job Post</a></li>
                    ...
                    <div class="mailbox-read-message">
                      <form action="reply-mailbox.php" method="post">
                        <div class="form-group">
                          <textarea class="form-control input-lg" id="description" name="description" placeholder="Enter Message"></textarea>
